...
const Contact = () => {
  ...
  const phoneNumber = contactSettings?.phone || String(siteSettings.support_phone || "+91 98765 43210");
  const displayPhone = phoneNumber.replace("+91", "").trim();
                  ...
                  <div className="rounded-lg bg-white/10 p-5">
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        ...
                        <p className="mt-1 text-sm text-white/85">{businessHours}</p>
                      </div>
                    </div>
                  </div>
                  <a
                ...
                <section className="overflow-hidden rounded-lg border border-[#d9dde5] bg-white shadow-sm">
                  <div className="flex items-center justify-between gap-4 border-b border-[#d9dde5] px-4 py-4 sm:px-6">
                    <div>
                      ...
                      <p className="mt-1 text-sm text-[#666]">{address}</p>
                    </div>
                    <MapPin className="h-6 w-6 text-[#315f9d]" />
                  </div>
                  <div className="h-[360px]">
                    {mapIframe ? (
                      ...
                      <div className="flex h-full items-center justify-center bg-[#f7f8fb] text-sm text-[#666]">
                        Map location will appear after the admin updates the contact settings.
                      </div>
                    )}
                  </div>
                </section>
